...
SECRET_KEY = '$adfzoo#wa*o*=i!)k3y%+vtn5tlpp4)qf9#^yntuy711+!1-#'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'guest',
        'USER': 'root',
        'PASSWORD': 'qigzJFJE233',
        'OPTIONS': {
            # 会提示警告： (3135, "'NO_ZERO_DATE', 'NO_ZERO_IN_DATE' and 'ERROR_FOR_DIVISION_BY_ZERO' sql modes
